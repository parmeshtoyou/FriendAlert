...
open class UserRequestModelEntityMapper @Inject constructor(): Mapper<UserEntity, UserRequestModel> {
    ...
    override fun mapFromEntity(type: UserEntity): UserRequestModel {
        return UserRequestModel(type.userId, type.firstName, type.lastName, type.phoneNumber, type.newPushNotificationToken, type.oldPushNotificationToken, type.active)
    }
    ...
    override fun mapToEntity(type: UserRequestModel): UserEntity {
        return UserEntity(type.userId.toString(), type.firstName, type.lastName, type.phoneNumber, type.pushNotificationToken, type.oldPushNotificationToken , type.active)
    }
